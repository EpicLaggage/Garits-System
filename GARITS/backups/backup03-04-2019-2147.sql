...
CREATE TABLE `Invoice` (
  ...
  `invoice_reminder` int(11) DEFAULT '0',
...
INSERT INTO `User` VALUES (2,'Penelope Carr','$2a$10$qVgL2I5MqMvp6Fuzi/.FK.H8DD6R7Vk5uvUgOb09IHlDcz64wELEK','Receptionist',NULL,'Penelope'),(3,'Sunny Evans','$2a$10$xektJgi7RD4weGOL2vUkJ.8mNILm2M/YUg1tisvZldSLKyrHC6IaK','Foreperson',125,'Sunny'),(5,'Administrator Role','$2a$10$16NCQAXIpcfvO8A44QgqCO36chRXKfHw40bzHsTebz8tU3HOu1qS.','Administrator',NULL,'SYSDBA'),(7,'Gavin Ross','$2a$10$.f12mM.mpiFvLbQfRvIpn.26TdQUqxiUO7Jg9wljgXM1bt/p.IDi.','Mechanic',105,'Gavin'),(8,'Anthony Wild','$2a$10$bJhVFtxQWbxA0HZtrYrWceWIYIjgOGGnElz3POj9t/woDjdU9zj.i','Mechanic',105,'Anthony'),(9,'Glynne Lancaster','$2a$10$9N9vzpaLQ2LrrmhcXIZjUOecCgS8G2KteB2PFBn3/9.JUKHWoucUG','Franchisee',NULL,'Glynne');
...
-- Dump completed on 2019-04-03 21:49:06
